...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("LaLaDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://laladesk.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://laladesk.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/laladesk/laladesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("laladesk docs home", LINK_DOCS_HOME),
        ("laladesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("laladesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.105.198"];
pub const RS_PUB_KEY: &str = "oixrqW9z7fNiZ7rtct+FC0g94WuxDUFWuGXrGEEFHLc=";

...
pub const VER_TYPE_RUSTDESK_CLIENT: &str = "laladesk-client";
pub const VER_TYPE_RUSTDESK_SERVER: &str = "laladesk-server";

pub fn version_check_request(typ: String) -> (VersionCheckRequest, String) {
    const URL: &str = "https://api.laladesk.com/version/latest";
